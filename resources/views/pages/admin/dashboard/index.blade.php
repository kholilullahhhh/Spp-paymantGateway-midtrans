                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    <div class="progress progress-thin">
                                        <div class="progress-bar bg-success" style="width: {{ ($paidPayments/$totalStudents)*100 }}%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="dashboard-card card h-100">
                            ...
                            <div class="card-body">
                                @forelse($classProgress as $class)
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex justify-content-between mt-1">
                                            ...
                                            <small>
                                                <a href="{{ route('payment.index') }}?class_id={{ $class->id }}" class="text-primary">
